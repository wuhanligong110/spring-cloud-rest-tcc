...
public class WeixinService {
	...
	public Map<String, String> wxprepay(HttpServletRequest request, HttpServletResponse response,WxprepayRequest wxprepayRequest) {
		...
		//客户信息
		CrmUser user = remoteWeixinUserInfo(request,response);
	...
	private CrmUser remoteWeixinUserInfo(HttpServletRequest request, HttpServletResponse response){
		ObjectDataResponse<CrmUser> dataResponse = accountClient.weixinUserinfo(request,response);

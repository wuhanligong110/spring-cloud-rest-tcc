...
import com.miget.hxb.web.RequestDetailsLogger;
import com.miget.hxb.web.ResponseDetailsLogger;
import com.miget.hxb.web.ServletContextHolder;
...
public class RequestLoggingAspect implements Ordered {
    ...
    @Around(value = "within(com.miget.hxb..*) " +
            "&& (@annotation(org.springframework.web.bind.annotation.ResponseBody)" +
            "|| @annotation(org.springframework.web.bind.annotation.RequestMapping)) " +
            "&& @annotation(com.miget.hxb.RequestLogging)")

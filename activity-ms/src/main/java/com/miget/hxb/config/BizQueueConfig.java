...
import com.miget.hxb.listener.BizMessageListener;
...
public class BizQueueConfig {
    ...
    */
   @Bean
   public SimpleMessageListenerContainer bizListenerContainer(ConnectionFactory connectionFactory, BizMessageListener bizMessageListener) {

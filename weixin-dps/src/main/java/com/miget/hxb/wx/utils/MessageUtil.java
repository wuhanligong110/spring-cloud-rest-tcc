...
public class MessageUtil {
    ...
    /**
     * 事件类型：subscribe(订阅)/扫描带参数二维码事件(用户未关注)
     */
    ...
    /**
     * @Description: 红包对象转换成 xml
     * @param @param textMessage
     * @param @return
     */
    public static String RedPackToXml(RedPack redPack) {
//        xstream.alias("xml", redPack.getClass());   	
//    	String requestXML = xstream.toXML(redPack);
        String requestXML = PaymentKit.objToXml(redPack);
        LOGGER.info("红包请求对象转换成 xml,requestXML={}",requestXML);
        return requestXML;
    }
